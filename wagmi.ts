// Generated by @wagmi/cli@1.3.0 on 12/11/2023 at 12:25:43 PM
...
export const demoLobbyABI = [
  ...
  },
  {
    ...
    anonymous: false,
    inputs: [
      { name: 'gameId', internalType: 'uint64', type: 'uint64', indexed: true },
      { name: 'stage', internalType: 'enum ILobby.GameStage', type: 'uint8', indexed: false },
      { name: 'position', internalType: 'uint8', type: 'uint8', indexed: true },
      { name: 'option', internalType: 'enum ILobby.BettingOption', type: 'uint8', indexed: false },
      { name: 'callAmount', internalType: 'uint256', type: 'uint256', indexed: false },
      { name: 'raiseAmount', internalType: 'uint256', type: 'uint256', indexed: false },
    ],
    name: 'Bet',
  },
  {
  ...
  },
  {
    ...
    type: 'function',
    inputs: [
      { name: 'deputy', internalType: 'address', type: 'address' },
      { name: 'until', internalType: 'uint64', type: 'uint64' },
      { name: 'signature', internalType: 'bytes', type: 'bytes' },
      { name: 'signedAt', internalType: 'uint64', type: 'uint64' },
    ],
    name: 'authorize',
    outputs: [],
  },
  {
    stateMutability: 'nonpayable',
    type: 'function',
    inputs: [{ name: 'deputy', internalType: 'address', type: 'address' }],
    ...
    outputs: [
      {
        ...
        components: [
          ...
          { name: 'activePlayers', internalType: 'uint8', type: 'uint8' },
...
export const demoTableABI = [
  ...
  },
  {
    ...
    inputs: [
      { name: 'player', internalType: 'address', type: 'address', indexed: true },
      { name: 'handRank', internalType: 'enum HandRanking', type: 'uint8', indexed: false },
      { name: 'kickers', internalType: 'uint64', type: 'uint64', indexed: false },
    ],
    name: 'ShowdownResult',
  },
  {
    ...
    inputs: [
      {
        ...
        components: [
          ...
          { name: 'lastStageBalancedBet', internalType: 'uint256', type: 'uint256' },
...
export const zkGameLobbyABI = [
  ...
  },
  {
    ...
    inputs: [
      { name: 'tableId', internalType: 'uint32', type: 'uint32' },
      { name: 'player', internalType: 'address', type: 'address' },
      { name: 'finalBalance', internalType: 'uint256', type: 'uint256' },
    ],
    name: 'reportPlayerLeft',
    outputs: [],
  },
...
export const zypherCampaignTokenABI = [
  {
    stateMutability: 'nonpayable',
    type: 'constructor',
    inputs: [
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'timeClaimable', internalType: 'uint256', type: 'uint256' },
    ],
    name: 'ClaimTimeout',
  },
  {
...
export const muAddressABI = [
  { type: 'error', inputs: [], name: 'AddressError' },
  { type: 'error', inputs: [], name: 'AddressInsuffcientBalance' },
  { type: 'error', inputs: [], name: 'AddressNotContract' },
] as const
...
export const muInitializableABI = [
  { type: 'error', inputs: [], name: 'AlreadyInitialized' },
  { type: 'error', inputs: [], name: 'Initializing' },
  { type: 'error', inputs: [], name: 'NotInitializing' },
  {
