// Generated by @wagmi/cli@1.3.0 on 8/21/2023 at 6:28:27 AM
...
export const demoTableABI = [
  ...
  },
  {
    stateMutability: 'view',
    type: 'function',
    inputs: [{ name: 'viewer', internalType: 'address', type: 'address' }],
  ...
  },
  {
    stateMutability: 'nonpayable',
    type: 'function',
    inputs: [{ name: 'totalAmount', internalType: 'uint256', type: 'uint256' }],
    name: 'raiseBets',
    outputs: [],
  },
  {
