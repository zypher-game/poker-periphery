// Generated by @wagmi/cli@1.3.0 on 8/22/2023 at 5:47:07 PM
...
export const demoTableABI = [
  ...
  { type: 'error', inputs: [], name: 'InvalidSignatureLength' },
  {
    type: 'error',
    inputs: [
      { name: 'currentStage', internalType: 'enum ITexasHoldemTable.GameStage', type: 'uint8' },
    ],
    name: 'InvalidStage',
  },
  {
  ...
  },
  {
    ...
    name: 'ff',
    outputs: [
      { name: 'stage_', internalType: 'enum ITexasHoldemTable.GameStage', type: 'uint8' },
  ...
  { stateMutability: 'nonpayable', type: 'function', inputs: [], name: 'forceStop', outputs: [] },
  {
    stateMutability: 'view',
    type: 'function',
    inputs: [],
  ...
  },
  {
    stateMutability: 'view',
    type: 'function',
    inputs: [{ name: 'gameId', internalType: 'uint64', type: 'uint64' }],
    ...
    outputs: [
      {
        ...
        components: [
          ...
          { name: 'draws', internalType: 'uint32', type: 'uint32' },
