...
export class IGameInstance__factory {
  ...
  static createInterface(): IGameInstanceInterface {
    return new utils.Interface(_abi) as IGameInstanceInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IGameInstance {
    return new Contract(address, _abi, signerOrProvider) as IGameInstance;
  }
}
