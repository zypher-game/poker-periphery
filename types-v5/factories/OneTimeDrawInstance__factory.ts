...
import type {
  OneTimeDrawInstance,
  OneTimeDrawInstanceInterface,
} from "../OneTimeDrawInstance";
...
export class OneTimeDrawInstance__factory {
  static readonly abi = _abi;
  static createInterface(): OneTimeDrawInstanceInterface {
    return new utils.Interface(_abi) as OneTimeDrawInstanceInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): OneTimeDrawInstance {
    return new Contract(address, _abi, signerOrProvider) as OneTimeDrawInstance;
  }
}
