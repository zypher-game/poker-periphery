...
export class ILobby__factory {
  ...
  static createInterface(): ILobbyInterface {
    return new utils.Interface(_abi) as ILobbyInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): ILobby {
    return new Contract(address, _abi, signerOrProvider) as ILobby;
  }
}
