...
export interface ICashmanInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface ICashman extends BaseContract {
  connect(runner?: ContractRunner | null): ICashman;
  ...
  buyIn: TypedContractMethod<
    [chipAmount: BigNumberish, to: AddressLike],
    [bigint],
    "payable"
  >;
  ...
  cashOut: TypedContractMethod<
    [chipAmount: BigNumberish, to: AddressLike],
    [[bigint, bigint] & { cashAmount: bigint; exceed: bigint }],
    "nonpayable"
  >;
